...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    // data 5 : here name and img are values we will pass to wear...

    private static String DATA_PATH = "/my_path";
...
/*
        cnt++;
        String str = name + cnt;
        putDataMapRequest.getDataMap().putString("name", str);
        putDataMapRequest.getDataMap().putInt("img", cnt);
...
/*
        Log.v("MA :", putDataMapRequest.getDataMap().getString("desc"));
        Log.v("MA :", putDataMapRequest.getDataMap().getDouble("low")+"");
        Log.v("MA :", putDataMapRequest.getDataMap().getDouble("gith")+"");
*/
